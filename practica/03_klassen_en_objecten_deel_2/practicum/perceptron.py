...
class Perceptron:
    ...
    def train(self, X, y, epochs=100, learningRate=0.1):
        ...
        for epoch in epochs:
            ...
            for inputVector, label in zip(X, y):
                ...
                # Predict output
                prediction = inputVector*self.weightVector+self.bias
                ...
                # update weight and b
                old_weight = self.weightVector
                self.weightVector = learningRate*error*inputVector
                deltaWeight = self.weightVector - old_weight
    ...
    def predict(self, inputVector):
        ...
        wsumresult = np.dot(self.weightVector, inputVector)+self.bias
        activation = wsumresult
